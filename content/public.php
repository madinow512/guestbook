 ...
 */
?>
<div class="absoluteElement halfPageContainer">
    <div class="autoWidthElement contentContainer">
        <h3>Das ist der öffentliche Bereich</h3>
...
<div class="absoluteElement halfPageContainer">
    <div class="autoWidthElement contentContainer">
        <h3>Ein paar andere Infos über diesen Bereich ...</h3>
        ...
        amet.
        Lorem ipsum dolor sit amet, consetetur sadipscing elitr, At accusam aliquyam diam diam dolore dolores duo eirmod
        eos erat,
        et nonumy sed tempor et et invidunt justo labore Stet clita ea et gubergren, kasd magna no rebum. sanctus sea
        sed takimata
        ut vero voluptua. est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur
    </div>
</div>